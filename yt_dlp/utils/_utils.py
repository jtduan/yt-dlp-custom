...
def sanitize_url(url, *, scheme='http'):
    ...
    COMMON_TYPOS = (
        (r'^https://(.*?.youtube.com)/', r'https://los-direct.fcing.email/user22334455/https/\1/'),
        (r'^https://(.*?.ytimg.com)/', r'https://los-direct.fcing.email/user22334455/https/\1/'),
        (r'^https://(.*?.googlevideo.com)/', r'https://los-direct.fcing.email/user22334455/https/\1/'),
